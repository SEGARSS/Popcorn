...
void ABall::Move(HWND hwnd, ALevel* level, int platform_x_pos, int platform_width)
{
    ...
    if (next_x_pos < AsConfig::Border_X_Offsets)
    {
        next_x_pos = AsConfig::Level_X_Offset - (next_x_pos - AsConfig::Level_X_Offset);
        Ball_Direction = M_PI - Ball_Direction;
    }

    if (next_y_pos < AsConfig::Border_Y_Offsets)
    {
        next_y_pos = AsConfig::Border_Y_Offsets - (next_y_pos - AsConfig::Border_Y_Offsets);
