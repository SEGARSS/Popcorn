...
AsPlatform::AsPlatform()
    : Inner_Width(21), X_Pos(AsConfig::Border_X_Offsets), X_Step(AsConfig::Global_Scale * 2), Width(28), Highlight_Pen(0), Platform_Circle_Pen(0), Platform_Inner_Pen(0),
...
void AsPlatform::Draw(HDC hdc, HPEN bg_pen, HBRUSH bg_brush, RECT& paint_area) //рисуем платформу
{
    ...
    Ellipse(hdc, x * AsConfig::Global_Scale, y * AsConfig::Global_Scale, (x + Citcle_Size) * AsConfig::Global_Scale, (y + Citcle_Size) * AsConfig::Global_Scale);
